...
<html>
    ...
    <body>
        <div class="container">
            <div class="header">
                <div class="profile-section">
                    ...
                    <div>
                        ...
                        <p style="margin: 5px 0; color: #7f8c8d;">${realtor.yearsInBusiness} years of experience</p>
                    </div>
                </div>
            </div>
            <div class="content">
            ...
            <div class="footer">
                <p>Licensed Real Estate Professional | Specializing in: ${realtor.markets.join(', ')}</p>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="stats">
                    <div class="stat">
                        <div class="stat-number">${realtor.yearsInBusiness}+</div>
            ...
            <div class="footer">
                ...
                <p style="margin: 5px 0 0 0; font-size: 12px; color: #6c757d;">Proudly serving: ${realtor.markets.join(' • ')}</p>
            </div>
        </div>
    </body>
</html>`;
